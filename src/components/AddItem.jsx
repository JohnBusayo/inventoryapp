                  ...
                  <Col md={6}>
                    <Form.Group className="mb-3">
                      ...
                      >
                        ...
                        <option value="Audio">Audio (Mics, Mixers)</option>
                        <option value="Video">Video (Cameras, Projectors)</option>
                        <option value="Lighting">Lighting (LEDs, Spotlights)</option>
                        <option value="Accessories">Accessories (Cables, Stands)</option>
                      </Form.Select>
                    </Form.Group>
                  </Col>
                  <Col md={6}>
